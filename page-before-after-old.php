<?php
/*
  Template Name: old before after
*/
?>
<?php get_header(); ?>
    ...
    <div class="static">
      ...
      <div class="static-contents before-after">
        ...
        <div class="abreast">
          <section class="image-compare-wrap">
            <div id="image-compare" class="image-compare">
              <img class="before" src="<?php echo get_template_directory_uri(); ?>/assets/img/before-after/before16.jpg" />
              <img class="after" src="<?php echo get_template_directory_uri(); ?>/assets/img/before-after/after16.jpg" />
            </div>
          </section>
          <section class="image-compare-wrap">
            <div id="image-compare" class="image-compare">
              <img class="before" src="<?php echo get_template_directory_uri(); ?>/assets/img/before-after/before17.jpg" />
              <img class="after" src="<?php echo get_template_directory_uri(); ?>/assets/img/before-after/after17.jpg" />
            </div>
          </section>
        </div>
