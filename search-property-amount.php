<?php
/*
  Template Name:search-property-amount
*/
?>
<?php get_header(); ?>

<?php $paged = get_query_var('paged') ? get_query_var('paged') : 1;
$min_value = isset($_GET['min_value']) && $_GET['min_value'] !== '' ? intval($_GET['min_value']) : 0;
$max_value = isset($_GET['max_value']) && $_GET['max_value'] !== '' ? intval($_GET['max_value']) : 999999;
...
$args = array(
  ...
  'meta_query' => array(
    array(
      'key' => 'amount', // カスタムフィールドのキー
      'value' => array($min_value, $max_value), // 範囲を配列で指定
      'type' => 'NUMERIC',        // 数値として評価
      'compare' => 'BETWEEN',     // 範囲検索
    ),
  ),
);
?>
    ...
    <div class="headline">
      ...
      <div class="breadcrumbs">
        <ol itemscope itemtype="http://schema.org/BreadcrumbList">
          ...
          <li itemprop="itemListElement" itemscope
            itemtype="http://schema.org/ListItem">
            <span itemprop="name"><?php if ($min_value !== null && $max_value !== null): ?>
                <?php echo $min_value; ?>万円以上<?php echo $max_value; ?>万円未満の結果一覧
            </span>
